...
module.exports = {
  ...
  'ops.bannersUploadImageEncrypted': {
    method: 'POST',
    path: '/bannerGames/upload-image-encrypted',
    encryptRequest: true,
    decryptResponse: true,
  },
  'ops.pushCampaignList': {
    method: 'POST',
    path: '/push-campaign/list',
    encryptRequest: true,
    decryptResponse: true,
  },
  'ops.pushCampaignCreate': {
    method: 'POST',
    path: '/push-campaign/create',
    encryptRequest: true,
    decryptResponse: true,
  },
  'ops.pushCampaignUpdate': {
    method: 'POST',
    path: '/push-campaign/update',
    encryptRequest: true,
    decryptResponse: true,
  },
  'ops.pushCampaignPause': {
    method: 'POST',
    path: '/push-campaign/pause',
    encryptRequest: true,
    decryptResponse: true,
  },
  'ops.pushCampaignResume': {
    method: 'POST',
    path: '/push-campaign/resume',
    encryptRequest: true,
    decryptResponse: true,
  },
  'ops.pushCampaignCancel': {
    method: 'POST',
    path: '/push-campaign/cancel',
    encryptRequest: true,
    decryptResponse: true,
  },
  'ops.pushCampaignSendNow': {
    method: 'POST',
    path: '/push-campaign/send-now',
    encryptRequest: true,
    decryptResponse: true,
  },
  'ops.pushCampaignRestart': {
    method: 'POST',
    path: '/push-campaign/restart',
    encryptRequest: true,
    decryptResponse: true,
  },
  'ops.withdrawalBlockGetAll': {
    method: 'POST',
    path: '/user-withdrawal-block/getAll',
    encryptRequest: false,
    decryptResponse: true,
  },
  'ops.withdrawalBlockAdd': {
    method: 'POST',
    path: '/user-withdrawal-block/add',
    encryptRequest: false,
    decryptResponse: true,
  },
  'ops.withdrawalBlockEdit': {
    method: 'POST',
    path: '/user-withdrawal-block/edit',
    encryptRequest: false,
    decryptResponse: true,
  },
  'ops.ggrAlertRecipientsGet': {
    method: 'POST',
    path: '/ggr-alert/recipients/get',
    encryptRequest: false,
    decryptResponse: true,
  },
  'ops.ggrAlertRecipientsSet': {
    method: 'POST',
    path: '/ggr-alert/recipients/set',
    encryptRequest: false,
    decryptResponse: true,
  },
  'ops.ggrAlertLogsGetAll': {
    method: 'POST',
    path: '/ggr-alert/logs/getAll',
    encryptRequest: false,
    decryptResponse: true,
  },
  'ops.ggrAlertRunCheck': {
    method: 'POST',
    path: '/ggr-alert/run-check',
    encryptRequest: false,
    decryptResponse: true,
  },
  ...
  // Laxmi NandiPlatform — plain JSON body; response may be encrypted envelope
  'dashboard.nandiPlatformDetails': {
    method: 'POST',
    path: '/SubAdmin/nandiPlatformDetails',
    encryptRequest: false,
    decryptResponse: true,
    keepDataEnvelope: true,
  },
  'dashboard.nandiPlatformByMarket': {
    method: 'POST',
    path: '/SubAdmin/nandiPlatformByMarket',
    encryptRequest: false,
    decryptResponse: true,
    keepDataEnvelope: true,
  },
  'dashboard.nandiPlatformPlayers': {
    method: 'POST',
    path: '/SubAdmin/nandiPlatformPlayers',
    encryptRequest: false,
    decryptResponse: true,
    keepDataEnvelope: true,
    timeout: 120000,
