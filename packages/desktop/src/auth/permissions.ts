...
import {
  ...
  isFullAccessNavRole as sharedIsFullAccessNavRole,
...
export function isFullAccessNavRole(user: StoredUser | null = getSessionUser()): boolean {
  return sharedIsFullAccessNavRole(user, storage);
}
