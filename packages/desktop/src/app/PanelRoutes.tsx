  ...
  return (
    <MemoryRouter initialEntries={['/welcome']}>
      ...
      <Suspense fallback={<PanelRouteFallback />}>
        <Routes>
          <Route element={<AppShell onLogout={logout} onUserChanged={goPanel} />}>
            ...
            <Route path="/falconRateManagement" element={<FalconRateManagementPage />} />
            ...
            <Route path="/bothMasterAddPage" element={<BothMasterAddPage />} />
            <Route path="/masterDashboard" element={<MasterDashboardPage />} />
            ...
            <Route path="/total-bonus-users-p" element={<BonusBalanceUsersPage />} />
            <Route path="/registered-users" element={<RegisteredUsersAppPage />} />
            <Route path="/house-games" element={<HouseGamesPage />} />
            <Route path="/leaderboard" element={<LeaderboardPage />} />
            <Route path="/customer-count" element={<LeaderboardCustomerCountPage />} />
            <Route path="/caller-responsibility" element={<CallerResponsibilityPage />} />
            <Route path="/caller-responsibility/deposit-list" element={<CallerDepositListPage />} />
            <Route path="/caller-responsibility/bot-users" element={<ActiveBotUsersPage />} />
            <Route path="/caller-responsibility/details" element={<CallerDetailsPage />} />
            <Route path="/player-activity" element={<PlayerActivityPage />} />
            <Route path="/player-activity/details" element={<PlayerActivityDetailsPage />} />
            <Route path="/game-activity" element={<GameActivityPage />} />
            <Route path="/game-activity/details" element={<GameActivityDetailsPage />} />
            <Route path="/game-activity/user-stats" element={<GameUserStatsPage />} />
            <Route path="/call-logs" element={<CallLogsPage />} />
            <Route path="/dialer-push-data" element={<DialerPushDataPage />} />
            <Route path="/new-registers" element={<NewRegistersPage />} />
            <Route path="/register-user-report" element={<StateWiseRegistrationPage />} />
            <Route path="/login-report" element={<LoginReportPage />} />
            <Route path="/all-user-login-report" element={<AllUserLoginReportPage />} />
            <Route path="/sos-blocked-users" element={<SosBlockedUsersPage />} />
            <Route path="/checkers-report" element={<CheckersReportPage />} />
            <Route path="/download-report" element={<SheetDownloadReportPage />} />
            <Route path="/downlaodReport" element={<Navigate to="/download-report" replace />} />
            ...
            <Route path="/betConstruct-lists" element={<BetConstructGamesPage />} />
            ...
            <Route path="/instant-provider" element={<InstantDepositProvidersPage />} />
            <Route path="/pay-g-mid" element={<DepositProvidersPage />} />
            <Route path="/mid-limits" element={<MidLimitsPage />} />
            <Route path="/deposit-config" element={<DepositConfigPage />} />
            <Route path="/payout-accounts" element={<WithdrawalProvidersPage />} />
            ...
            <Route path="/roles-responsibilities" element={<RolesResponsibilitiesPage />} />
            <Route path="/dynamic-casino-switching" element={<CasinoSwitchPage />} />
            <Route path="/top-games" element={<TopGamesPage />} />
            <Route path="/casino-topup-balance" element={<CasinoTopupBalancePage />} />
            <Route path="/depositList" element={<DepositListPage />} />
            <Route path="/depositList/user-wise" element={<DepositListUserWisePage />} />
            ...
            <Route path="/funds/mid/payingAccount" element={<FundsPayinPage />} />
            <Route path="/whatsappView" element={<WhatsappPage />} />
            <Route path="/fund-request-bonus-wallet" element={<BonusWalletFundRequestPage />} />
            <Route
            ...
            <Route path="/DepositApprovedReport" element={<DepositApprovedReportPage />} />
            <Route path="/unique_deposit_pending" element={<UniqueDepositPendingPage />} />
            ...
            <Route path="/fund-request-coin" element={<FundRequestCoinTablePage />} />
            <Route path="/playerRtp" element={<PlayerRtpPage />} />
            <Route path="/playerRtp/details" element={<PlayerRtpDetailsPage />} />
            <Route path="/users" element={<UsersPage />} />
            <Route path="/users/report/:userId/:userName" element={<UserReportPage />} />
            <Route path="/bonus-wallet-referral-earning" element={<BonusEarningPage />} />
            <Route path="/user_exposure" element={<UserExposurePage />} />
            <Route path="/dumpUsers" element={<DumpUsersPage />} />
            <Route path="/callerAllotment" element={<CallerAllotmentPage />} />
            ...
            <Route path="/aaa-fraud-bet-report" element={<AAAFraudBetReportPage />} />
            <Route path="/aaa-blacklisted-users" element={<AAABlacklistedUsersPage />} />
