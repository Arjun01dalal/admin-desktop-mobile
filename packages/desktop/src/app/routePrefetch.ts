...
const LOADERS: Record<string, Loader> = {
  ...
  '/nandi-platform': () => import('@/screens/panel/dashboards/NandiPlatformPage'),
  ...
  '/push-notifications': () => import('@/screens/panel/PushNotificationsPage'),
  '/block-withdrawal': () => import('@/screens/panel/BlockWithdrawalPage'),
  '/ggr-alert': () => import('@/screens/panel/GgrAlertPage'),
