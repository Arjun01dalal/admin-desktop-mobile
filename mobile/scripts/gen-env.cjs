 ...
 * Reads either the root .env (dev) or electron/env.generated.cjs (embedded build values),
...
if (!base || !entk) {
  try {
    const embedded = require(path.join(ROOT, 'electron/env.generated.cjs'));
...
const out = path.join(ROOT, 'mobile', '.env');
