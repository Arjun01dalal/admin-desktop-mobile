...
- [Mobile app sharing](mobile-app-sync.md) — mobile/ Expo app reuses desktop logic via generated copies (sync-shared.cjs); Expo web preview needs CI=1 (no xdg-open on Replit).
